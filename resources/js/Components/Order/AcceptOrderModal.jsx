            ...
            >
                ...
                <div className="flex flex-col ">
                    <div className="pt-2.5 pb-5 border-b border-zinc-100 rounded-md">
                        ...
                        <div className="flex flex-col px-5 py-4 bg-zinc-800 text-gray-300 text-sm rounded-lg tracking-wider mt-5">
                ...
                >
                    <div className="flex justify-between gap-5">
                        <div className="mb-6 relative w-1/2">
                            ...
                            <div className="flex">
                                <input
                                    className="bg-gray-300 border border-gray-300 text-gray-900 text-xl font-bold rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-10"
                                    id="default-input"
                                    value={parseInt(
                                        order.minimumPrice || "50000"
                                    )}
                                    type="text"
